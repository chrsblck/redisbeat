...
SECTIONS = [
    ("env", "Common"),
    ("server", "Redis Server Statistics"),
    ("clients", "Redis Client Statistics"),
    ("memory", "Redis Memory Statistics"),
    ("persistence", "Redis Persistence Statistics"),
    ("stats", "Redis Stats Statistics"),
    ("replication", "Redis Replication Statistics"),
    ("cpu", "Redis CPU Statistics"),
    ("commandstats", "Redis CommandStats Statistics"),
    ("cluster", "Redis Cluster Statistics"),
    ("keyspace", "Redis Keyspace Statistics")]
